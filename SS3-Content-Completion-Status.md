...
- **Horticulture and Crop Production** — live as of 2026-09-05 (First, Second and Third Term,
  ...
  section. Distinct from the existing broader "Agriculture" subject in the 62-subject
  catalogue above, which was left untouched. Unlike SS1/SS2's identical 24-topic (8-per-term)
  structure for this same subject, SS3's Second and especially Third Term content follows a
  generic "final-year project + exam prep" template shared across several SS3 trade subjects
  on this page — once exam-prep, revision, and past-question-review weeks are excluded
  (matching the exclusion pattern already established for the pre-existing SS3 "Solar
