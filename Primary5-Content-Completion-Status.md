...
**Status: 12 subjects live**, DB-verified 2026-09-03 (grade-level aggregate: 12 subjects,
421 topics). Hausa was added this session via the nerdc-curriculum-sourcer pipeline,
sourced from SchemeofWork.com. Still short of the reconciled 16-subject NESRI 2025 target
(see root `CLAUDE.md` "Remaining sourcing gaps" section) — missing Igbo, Islamic Studies,
and Arabic Language.
...
## Data-provenance gap: 10 of 12 subjects

Only Mathematics and Hausa have a real, git-tracked source file and importer commit. The
other 10 subjects went through the repo's original, pre-agent seeding path:
...
Missing from the reconciled 16-subject NESRI 2025 target (see root `CLAUDE.md`): Igbo,
Islamic Studies, and Arabic Language — none checked against real sources yet.

Beyond that, and the provenance gap above — all 12 subjects have full topic sets live in
